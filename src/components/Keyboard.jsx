        ...
        <div className='grid grid-cols-3 gap-1 flex-1 items-center'>
            {
                buttons_left.map(button => (
                    <div className='grid place-items-center w-full h-full bg-white/65 rounded-full font-semibold cursor-pointer'>{button}</div>
                ))
            }
        </div>
        ...
        <div className='h-full w-[23%] grid items-center gap-1'>
            {
                button_right.map(button => (
                    <div className='grid place-items-center w-full h-full  rounded-full font-bold bg-amber-300 cursor-pointer'>{button}</div>
                ))
            }
